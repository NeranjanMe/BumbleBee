		                    ...
		                    <div class="row position-relative" style="top: 0;">
		                        <div class="col-6 col-sm-6 col-md position-relative">
		                            <div class="form-floating position-relative">
		                                ...
		                                <input type="text" class="form-control bg-transparent border-3 w-100" id="categoryIdInManageCategory" name="categoryIdInManageCategory" placeholder="Category ID" style="height: 40px;" value=<%=categoryCode%>>
		                                <label for="categoryIdInManageCategory" id="categoryIdLblInCategory"><span>Category ID</span></label>
		                            </div>
		                        </div>
		                        <div class="col-6 col-sm-6 col-md">
		                            <div class="form-floating position-relative">
		                                <input type="text" class="form-control bg-transparent border-3 w-100" id="categoryNameInManageCategory" name="categoryNameInManageCategory" placeholder="Category Name" style="height: 40px;">
		                                <label for="categoryNameInManageCategory" id="categoryNameLblInCategory"><span>Category Name</span></label>
		                            </div>
		                        </div>
		                    </div>
		                </div>
		            ...
		            <div class="row container position-relative" style="left: 0;right:0;margin: auto; width: 80%;height: 10%;">
		                <div class="col-sm-6 col-md-3 position-relative">
		                    <div class="col-11 position-absolute" style="top: 0;bottom: 0;left:0;right:0;margin: auto;">
		                        <button id="saveCategory" class="btn btn-outline-success position-absolute" style="top: 0;bottom: 0;margin: auto;height: 40px; width: 100%;">Add Category
		                        </button>
		                    </div>
		                </div>
		                <div class="col-sm-6 col-md-3 position-relative">
		                    <div class="col-11 position-absolute" style="top: 0;bottom: 0;left:0;right:0;margin: auto;">
		                        <button class="btn btn-outline-secondary position-absolute" style="top: 0;bottom: 0;margin: auto;height: 40px;width: 100%;" id="updateCategoryBtn">
		                            Update Category
		                        </button>
		                    </div>
		                </div>
		                <div class="col-sm-6 col-md-3 position-relative">
		                    <div class="col-11 position-absolute" style="top: 0;bottom: 0;left:0;right:0;margin: auto;">
		                        <button class="btn btn-outline-danger position-absolute" style="top: 0;bottom: 0;margin: auto;height: 40px;width: 100%;" id="deleteCategoryBtn">
		                            Delete Category
		                        </button>
		                    </div>
		                </div>
